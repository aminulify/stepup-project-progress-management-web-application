...
const TeamTable = ({teamData, teamDataFetch, setLoading}) => {
    ...
    const handleUpdateTeamMemberData = (e) =>{
        ...
        // console.log(`http://localhost:3000/api/user-updated-data/${modalId}`);
        axios.patch(`http://localhost:3000/api/user-update-data/${modalId}`, {username, rolePosition, role, isActive})
        .then(res => {
            setLoading(true);
